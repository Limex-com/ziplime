...
Connectors are discovered, not hardcoded: removing ``ziplime/data/data_sources/finam/`` leaves an
international build that still lists Yahoo Finance, and a third-party package advertising a
