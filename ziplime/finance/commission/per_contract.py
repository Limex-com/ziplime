...
from ziplime.finance.constants import (
    DEFAULT_FUTURE_EXCHANGE_FEE, FUTURE_EXCHANGE_FEES_BY_SYMBOL,
)
...
class PerContract(FutureCommissionModel):
    ...
    def __init__(
        ...
        if isinstance(exchange_fee, (int, float)):
            ...
            # defaultdict, not a plain merge: a root the tables do not cover used to raise
            # KeyError in the middle of a simulation.
            self._exchange_fee = defaultdict(
                lambda: DEFAULT_FUTURE_EXCHANGE_FEE,
