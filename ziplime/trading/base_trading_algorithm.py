...
class BaseTradingAlgorithm:
    ...
    async def symbols(self, *args, **kwargs) -> list[ExchangeAsset]: ...

    async def sid(self, sid: int) -> ExchangeAsset | None: ...
    ...
    async def cancel_order(self, order_id: str, relay_status: bool = True) -> None: ...
