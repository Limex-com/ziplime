...
package may import it, and discovery tolerates a connector that is not installed: deleting
``ziplime/data/data_sources/finam/`` leaves an international build that still ships Yahoo Finance.
...
BUILTIN_PROVIDER_MODULES: tuple[str, ...] = (
    ...
    "ziplime.data.data_sources.finam.provider",
)
