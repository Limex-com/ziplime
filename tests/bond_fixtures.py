...
def make_bond(sid: int = 501, symbol: str = "TESTBOND", face_value: float = 1000.0,
    ...
    bond = Bond(
        ...
        coupon_frequency=coupon_frequency, quote_currency="RUB", day_count=day_count,
    ...
    return ExchangeAsset(
        ...
        auto_close_date=maturity_date, external_id="", exchange=EXCHANGE, asset=bond, quote=RUB)
...
def trade(ledger: Ledger, asset: ExchangeAsset, amount: int, price: float,
    ...
    ledger.process_transaction(Transaction(
        ...
        amount=amount, dt=when, price=price, exchange_name="MOEX",
    ...
    if position is not None:
        ledger.position_tracker.update_position(
            asset=asset, exchange_name="MOEX", trading_account_id="account-1",
