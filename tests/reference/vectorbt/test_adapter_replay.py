...
in the main test directory: `tests/reference/vectorbt/` is the one place `pip uninstall vectorbt`
...
# Three levels up now: tests/reference/vectorbt/ -> tests/reference/ -> tests/ -> the repository.
